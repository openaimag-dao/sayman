...
const DEFAULT_PRODUCTS = {
  food: [
    { id: "f1", cat: "Хлеб и выпечка", name: "Хлеб формовой", unit: "шт", price: 180, emoji: "🍞", hit: true },
    { id: "f2", cat: "Хлеб и выпечка", name: "Лепёшка тандырная", unit: "шт", price: 250, emoji: "🫓", hit: true },
    { id: "f3", cat: "Хлеб и выпечка", name: "Батон нарезной", unit: "шт", price: 220, emoji: "🥖" },
    { id: "f4", cat: "Хлеб и выпечка", name: "Баурсаки (10 шт)", unit: "уп", price: 500, emoji: "🥯" },
    { id: "f5", cat: "Молочные", name: "Молоко 2,5% 1 л", unit: "шт", price: 450, oldPrice: 490, emoji: "🥛" },
    ...
    { id: "f9", cat: "Молочные", name: "Сыр «Голландский» 300 г", unit: "шт", price: 1650, emoji: "🧀" },
    ...
    { id: "f12", cat: "Бакалея", name: "Рис «Лазер» 1 кг", unit: "кг", price: 950, emoji: "🍚" },
    { id: "f13", cat: "Бакалея", name: "Гречка 800 г", unit: "уп", price: 780, emoji: "🌾" },
    { id: "f14", cat: "Бакалея", name: "Макароны «Корона» 400 г", unit: "уп", price: 380, emoji: "🍝" },
    { id: "f15", cat: "Бакалея", name: "Мука в/с 2 кг", unit: "уп", price: 1100, emoji: "🌾" },
    ...
    { id: "f21", cat: "Бакалея", name: "Яйца С1, 10 шт", unit: "уп", price: 850, emoji: "🥚" },
    { id: "f22", cat: "Овощи и фрукты", name: "Картофель", unit: "кг", price: 320, emoji: "🥔" },
    { id: "f23", cat: "Овощи и фрукты", name: "Лук репчатый", unit: "кг", price: 250, emoji: "🧅" },
    { id: "f24", cat: "Овощи и фрукты", name: "Морковь", unit: "кг", price: 280, emoji: "🥕" },
    { id: "f25", cat: "Овощи и фрукты", name: "Помидоры", unit: "кг", price: 850, emoji: "🍅" },
    { id: "f26", cat: "Овощи и фрукты", name: "Огурцы", unit: "кг", price: 750, emoji: "🥒" },
    { id: "f27", cat: "Овощи и фрукты", name: "Яблоки апорт", unit: "кг", price: 780, emoji: "🍎" },
    { id: "f28", cat: "Овощи и фрукты", name: "Бананы", unit: "кг", price: 990, emoji: "🍌" },
    { id: "f29", cat: "Овощи и фрукты", name: "Лимоны", unit: "кг", price: 1200, emoji: "🍋" },
    { id: "f30", cat: "Мясо и колбасы", name: "Говядина (мякоть)", unit: "кг", price: 3400, emoji: "🥩" },
    { id: "f31", cat: "Мясо и колбасы", name: "Курица (тушка)", unit: "кг", price: 1650, emoji: "🍗" },
    ...
    { id: "f35", cat: "Заморозка", name: "Пельмени «Домашние» 900 г", unit: "уп", price: 1950, emoji: "🥟", hit: true },
  ...
  build: [
    ...
    { id: "b4", cat: "Стеновые материалы", name: "Кирпич красный М100", unit: "шт", price: 95, emoji: "🧱" },
    ...
    { id: "b8", cat: "Краски и отделка", name: "Эмаль ПФ-115 белая 2,7 кг", unit: "банка", price: 3400, emoji: "🎨" },
    { id: "b9", cat: "Краски и отделка", name: "Грунтовка глубокого проникн. 10 л", unit: "шт", price: 4200, emoji: "🪣" },
